                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('update_setting',['id'=>$settingEdit->id]) }}" method="post" >
                                        <div class="form-group">
                                            <label for="inputName">Config_key : </label>
                                            <input type="text" id="config_key" name='config_key'
                                                class="form-control @error('config_key') is-invalid @enderror"
                                                placeholder="Nhập Config_key..." value="{{ $settingEdit->config_key }}">
                                            @error('config_key')
                                        ...
                                        @if (request()->type === 'Text')
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="config_value" name='config_value'
                                                    ...
                                                    value="{{ $settingEdit->config_value }}">
                                                @error('config_value')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        @csrf
                                        <input type="submit" value="Cập nhập Setting" class="btn btn-success ">
